...
Για όλα τα benchmarks ισχύει:  
  ...
  <pre>Περιγραφή: Τα διάφορα μέρη του συστήματος χρονίζονται στο 1GHz, ενώ οι πυρήνες του συστήματος και όποιοι επεξεργαστές προστίθενται στην συνέχεια χρονίζονται στα 2GHz (στα μέρη </pre>
     <br><br>
