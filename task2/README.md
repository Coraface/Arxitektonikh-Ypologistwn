...
_Benchmark 470_:  
  ...
  5. _`l2_misses : 0.999940`_  
    ...
    της προσομοίωσης του benchmark. Συγκεκριμένα στο παράδειγμα μας το benchmark 458 έχει μεγάλες τιμές Misses που 
    συνεπάγεται σε μεγάλο CPI και άρα μεγάλο χρόνο εκτέλεσης της προσομοίωσης. Αντίθετα, το benchmark 456 έχει 
    τον μικρότερο αριθμό Misses σε όλες τις μνήμες, που αντιστοιχίζεται στο μικρότερο CPI και άρα στον καλύτερο 
