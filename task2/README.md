...
_Benchmark 470_:  
  ...
  5. _`l2_misses : 0.999940`_  
    ...
    Συγκεκριμένα στο παράδειγμα μας για το benchmark 458 έχει μεγάλες τιμές στα Misses που συνεπάγεται σε μεγάλο
    CPI και άρα μεγάλο χρόνο εκτέλεσης της προσομοίωσης. Αντίθετα, το benchmark 456 έχει τον μικρότερο αριθμό Misses
    σε όλες τις μνήμες, που αντιστοιχεί στο μικρότερο CPI και τον καλύτερο(μικρότερο) χρόνο προσομοίωσης.
    </pre>
   <br><br>
